...
import com.capgemini.airlinereservationsystempassenger.exception.FlightNameAlreadyExitsException;
...
public class FlightDaoImpl implements FlightDao {
	...
	public boolean flightRegister(FlightBean flightbean) {
		...
		try {
			...
			throw new FlightNameAlreadyExitsException("Flight Name Already Exits");
		}
	}
